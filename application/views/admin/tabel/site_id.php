      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?= base_url('admin/site_id')?>"><i class="fa fa-circle-o"></i> Tabel SITE ID</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Tables</li>
        <li class="active"><a href="<?=base_url('admin/site_id')?>">Tabel SITE ID</a></li>
      </ol>
    </section>
