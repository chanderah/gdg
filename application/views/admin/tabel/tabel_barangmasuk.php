              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <?php foreach($list_data as $dd): ?>
                    ...
                    <td><?=$dd->no_sertif?></td>
                    <td><?=$dd->keterangan?></td>
                    <td><a type="button" class="btn btn-info" href="<?=base_url('admin/update_datamasuk/'.$dd->no)?>" name="btn_update" style="margin:auto;"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
