...
<html>
  <head>
    <title>CRUD Database | User</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top bg-dark">
      <div class="container">
        <div class="navbar-header">
          <a class="navbar-brand" href="<?= base_url('user')?>">CRUD Database</a>
        </div>
          <ul class="nav navbar-nav mr-auto">
            ...
            <li class="dropdown"><a class="bg-dark dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-database" aria-hidden="true"></i> Tabel <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li><a href="<?=base_url('user/form_suratpermohonan');?>">Surat Permohonan</a></li>
