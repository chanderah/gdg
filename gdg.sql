...
INSERT INTO `tb_site_id` (`id`, `id_transaksi`, `tanggal_masuk`, `tanggal_keluar`, `lokasi`, `kode_barang`, `nama_barang`, `satuan`, `jumlah`) VALUES
...
--
DELIMITER $$
CREATE TRIGGER `TG_BARANG_KELUAR` AFTER INSERT ON `tb_site_id` FOR EACH ROW BEGIN
 UPDATE tb_permintaan_masuk SET jumlah=jumlah-NEW.jumlah
 WHERE kode_barang=NEW.kode_barang;
 DELETE FROM tb_permintaan_masuk WHERE jumlah = 0;
...
INSERT INTO `tb_permintaan_masuk` (`id_transaksi`, `tanggal`, `lokasi`, `kode_barang`, `nama_barang`, `satuan`, `jumlah`) VALUES
...
--
-- AUTO_INCREMENT for table `tb_site_id`
--
ALTER TABLE `tb_site_id`
